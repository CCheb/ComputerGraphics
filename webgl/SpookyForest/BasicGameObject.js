...
class Bush extends GameObject
{
	constructor()
	{
		...
		this.vertices =
		[
			0.3,0.8,0.3, 0.0,1.0,0.0, // a
			-0.3,0.8,-0.3, 0.0,1.0,0.0, // b
			-0.3,0.8,0.3, 0.0,1.0,0.0, // c
			0.3,0.8,0.3, 0.0,1.0,0.0, // d
			-0.3,0.8,-0.3, 0.0,1.0,0.0, // g
			0.3,0.8,-0.3, 0.0,1.0,0.0, // v

			0.0,0.5,0.7, 0.0,1.0,0.0, // a1
			0.5,0.5,0.5, 0.0,1.0,0.0, // b1
			0.3,0.8,0.3, 0.0,1.0,0.0, // d
			...
			-0.5,0.5,0.5, 0.0,1.0,0.0, // c1
			0.0,0.5,0.7, 0.0,1.0,0.0, // a1
			-0.3,0.8,0.3, 0.0,1.0,0.0, // c

			//15
			-0.7,0.5,0.0 , 0.0,1.0,0.0, // a2
			-0.5,0.5,0.5, 0.0,1.0,0.0, // c1
			-0.3,0.8,0.3, 0.0,1.0,0.0, // c
			...
			//21
			-0.5,0.5,-0.5, 0.0,1.0,0.0, // b2
			-0.7,0.5,0.0 , 0.0,1.0,0.0, // a2
			-0.3,0.8,-0.3, 0.0,1.0,0.0, // g

			//23
			0.0,0.5,-0.7, 0.0,1.0,0.0, // a3
			-0.5,0.5,-0.5, 0.0,1.0,0.0, // b2
			-0.3,0.8,-0.3, 0.0,1.0,0.0, // g
			...
			//29
			0.5,0.5,-0.5, 0.0,1.0,0.0, // b3
			0.0,0.5,-0.7, 0.0,1.0,0.0, // a3
			0.3,0.8,-0.3, 0.0,1.0,0.0, // v

			//32
			0.7,0.5,0.0, 0.0,1.0,0.0, // a4
			0.5,0.5,-0.5, 0.0,1.0,0.0, // b3
			0.3,0.8,-0.3, 0.0,1.0,0.0, // v
			...
			0.7,0.5,0.0, 0.0,1.0,0.0, // a4
			0.5,0.5,0.5, 0.0,1.0,0.0, // b1
			0.5,0.2,0.5, 0.0,1.0,0.0, // a5

			//48
			0.7,0.5,0.0, 0.0,1.0,0.0, // a4
			0.5,0.2,0.5, 0.0,1.0,0.0, // a5
			0.7,0.2,0.0, 0.0,1.0,0.0, // b5
			...
			0.3,-0.1,0.3, 0.0,1.0,0.0, // a
			-0.3,-0.1,-0.3, 0.0,1.0,0.0, // b
			-0.3,-0.1,0.3, 0.0,1.0,0.0, // c
			0.3,-0.1,0.3, 0.0,1.0,0.0, // d
			-0.3,-0.1,-0.3, 0.0,1.0,0.0, // g
			0.3,-0.1,-0.3, 0.0,1.0,0.0, // v




			0.0,0.2,0.7, 0.0,1.0,0.0, // a1
			0.5,0.2,0.5, 0.0,1.0,0.0, // b1
			0.3,-0.1,0.3, 0.0,1.0,0.0, // d
			...
			//99
			-0.5,0.2,0.5, 0.0,1.0,0.0, // c1
			0.0,0.2,0.7, 0.0,1.0,0.0, // a1
			-0.3,-0.1,0.3, 0.0,1.0,0.0, // c

			//102
			-0.7,0.2,0.0 , 0.0,1.0,0.0, // a2
			-0.5,0.2,0.5, 0.0,1.0,0.0, // c1
			-0.3,-0.1,0.3, 0.0,1.0,0.0, // c
			...
			//108
			-0.5,0.2,-0.5, 0.0,1.0,0.0, // b2
			-0.7,0.2,0.0 , 0.0,1.0,0.0, // a2
			-0.3,-0.1,-0.3, 0.0,1.0,0.0, // g

			//101
			0.0,0.2,-0.7, 0.0,1.0,0.0, // a3
			-0.5,0.2,-0.5, 0.0,1.0,0.0, // b2
			-0.3,-0.1,-0.3, 0.0,1.0,0.0, // g
			...
			//107
			0.5,0.2,-0.5, 0.0,1.0,0.0, // b3
			0.0,0.2,-0.7, 0.0,1.0,0.0, // a3
			0.3,-0.1,-0.3, 0.0,1.0,0.0, // v

			//110
			0.7,0.2,0.0, 0.0,1.0,0.0, // a4
			0.5,0.2,-0.5, 0.0,1.0,0.0, // b3
			0.3,-0.1,-0.3, 0.0,1.0,0.0, // v
