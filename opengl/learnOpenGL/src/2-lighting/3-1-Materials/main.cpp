...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // light properties that are kept as a struct in the fragment shader
        ...
        lightingShader.setFloat("material.shininess", 32.0f);   // how big the specular highlight is
        ...
        lightCubeShader.use();
        lightCubeShader.setVec3("lightColor", lightColor);  // setting the color of the lamp to match the emitted light
