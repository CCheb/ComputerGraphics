...
// point light struct with all necessary variables that
// allow for point light calculations
struct PointLight {
    vec3 position;
...
// Pre-processor directive for specifying the amount of point lights
...
// since we are woring with 4 point lights we need to specify the attributes for each
